...
- 리더보드 BSS: **939.9186320496**
- 공개 버전: 기본 앙상블 60% + 단조 제약 앙상블 40%
...
│   └── train_monotone.py        # 단조 모델 학습 및 40% 블렌드 설정
...
`artifacts/submit_40pct_lb939.918632.zip`은 실제 리더보드에서 939.9186320496점을 기록한 보존용 스냅샷입니다.
...
첫 번째 명령은 기본 모델 3종을 학습하고, 두 번째 명령은 단조 제약 모델을 학습한 뒤 60:40 앙상블 메타데이터를 구성합니다.
...
최종 확률은 기본 앙상블 60%, 단조 제약 앙상블 40%의 가중 평균입니다.
